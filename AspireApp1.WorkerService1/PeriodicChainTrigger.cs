    ...
    IHostEnvironment hostEnvironment) : BackgroundService
{
    ...
    private async Task RunChainAsync(CancellationToken stoppingToken)
    {
        ...
        logger.LogInformation("Chain trigger started. trace_id={trace_id} span_id={span_id} service.name={service_name} correlation_id={correlation_id} timestamp_utc={timestamp_utc}",
        ...
        logger.LogInformation("Chain trigger completed. trace_id={trace_id} span_id={span_id} service.name={service_name} correlation_id={correlation_id} timestamp_utc={timestamp_utc}",
            Activity.Current?.TraceId.ToString(),
            Activity.Current?.SpanId.ToString(),
            hostEnvironment.ApplicationName,
            correlationId,
